...
//	string queryFold = "F:\\Lab\\My_CUHK_Dataset\\category_based_test\\";
	const string saveFold = "E:\\Lab\\Category_Ranking_AVA_14\\DCNN_test\\category_based_test\\";
	const string queryFold = "F:\\Lab\\Category_Ranking_AVA_14\\category_based_test\\";

	const string srcFold = "F:\\Lab\\Category_Ranking_AVA_14\\category_based_test\\";
	...
	for (int i=0; i<foldNames.size(); i++)
	{
		...
		makeDir(saveFold+foldNames[i]+"\\"); // create folder 
